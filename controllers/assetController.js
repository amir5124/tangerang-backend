...
const fs = require('fs');
const path = require('path'); // Wajib diimpor!
...
exports.uploadAndUpdateAsset = async (req, res) => {
    ...
    // Pastikan path image_url konsisten dengan folder statis Anda
    ...
    try {
        ...
        if (existing.length > 0 && existing[0].image_url) {
            // Gabungkan root dir dengan path image_url yang tersimpan di DB
